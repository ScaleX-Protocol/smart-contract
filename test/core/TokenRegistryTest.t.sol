...
contract TokenRegistryTest is Test {
    ...
    function test_DefaultMappingsRegistered() public {
        // Test Appchain USDT -> Rari gsUSDT mapping
        ...
        assertEq(syntheticToken, 0x8bA339dDCC0c7140dC6C2E268ee37bB308cd4C68); // gsUSDT
        
        // Test reverse lookup
        (uint32 sourceChainId, address sourceToken) = tokenRegistry.getSourceToken(
            1918988905, // Rari
            0x8bA339dDCC0c7140dC6C2E268ee37bB308cd4C68 // gsUSDT
        );
    ...
    function test_ConvertAmount() public {
        ...
        result = tokenRegistry.convertAmount(1000000, 6, 18); // 1 USDT
    ...
    function test_GetChainTokens() public {
        ...
        assertEq(tokens.length, 3); // USDT, WETH, WBTC
        
        assertEq(tokens[0], 0x1362Dd75d8F1579a0Ebd62DF92d8F3852C3a7516); // USDT
