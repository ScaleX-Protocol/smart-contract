...
contract UpdateRiseTokenMappings is Script {
    
    function run() public {
        uint256 deployerPrivateKey = vm.envUint("PRIVATE_KEY");
        address deployer = vm.addr(deployerPrivateKey);
        
        console.log("========== UPDATE RISE TOKEN MAPPINGS ==========");
        ...
        address mailbox = vm.parseJsonAddress(riseData, ".mailbox");
        ...
        console.log("");
        console.log("=== SOURCE TOKENS (RISE) ===");
        ...
        console.log("========== RISE TOKEN MAPPINGS UPDATED ==========");
    }
}