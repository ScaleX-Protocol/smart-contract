...
contract DebugHealthFactor is Script {
    function run() external view {
        ...
        // Get oracle prices (via LendingManager's price getters)
        console.log("=== ORACLE PRICES ===");
        uint256 idrxPrice = lm.getCollateralPrice(idrx);
        uint256 wethPrice = lm.getCollateralPrice(weth);
    ...
    function getAvailableLiquidity() external view returns (uint256) {
        address lendingManager = 0x17D803b6Bb4ECF60e8f8b60f4489afdA1743e021;
        LendingManager lm = LendingManager(lendingManager);
        address weth = 0x8b732595a59c9a18acA0Aca3221A656Eb38158fC;
        return lm.getAvailableLiquidity(weth);
    }
}
